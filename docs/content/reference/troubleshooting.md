...
Most of these come down to network reality or how dataverse serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dataverse rate-limits like any public site. dataverse already paces
...
Where a surface is gated, dataverse reads a cookie or token you supply
...
`dataverse`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dataverse actually did
