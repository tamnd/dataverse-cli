...
```
dataverse <command> [arguments] [flags]
```

Run `dataverse <command> --help` for the full flag list on any command. This
...
per operation you declare in `dataverse/domain.go`.
