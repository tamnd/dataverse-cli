...
func TestHostWiring(t *testing.T) {
	...
	if want := "dataverse://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("dataverse", "about")
	if err != nil || got.String() != "dataverse://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want dataverse://page/about", got.String(), err)
	}
}
